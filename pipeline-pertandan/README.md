...
| **Gerbang G2** | Evaluasi *End-to-End* Tanpa Data Acuan Kebenaran | **LOLOS** | Akurasi klasifikasi end-to-end $−1,81\text{ pp}$ vs model batas atas teoretis (*oracle*) (memenuhi toleransi $\le 2,0\text{ pp}$). |
| **Gerbang G3** | Pencacahan Berbasis Klaster Graf Murni | **GUGUR** | Macro-$MAE = 3,4610$ vs $1,0542$ pada *Ridge +* $F_{\text{all}}$ (pencacahan klaster graf lebih rendah presisinya dari estimator regresi). |
