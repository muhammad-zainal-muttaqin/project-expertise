...
**Dibandingkan dengan garis dasar pembanding (*baseline*) test-locked yang dirujuk orkestrator** (F1 0,8043 / MAE 1,3926 / ±1 0,6148 / *matched* ≈0,7111): F1 0,8387 vs 0,8043 (Δ=+0,0344); MAE 1,3630 vs 1,3926 (Δ=−0,0296); ±1 0,6370 vs 0,6148 (Δ=+0,0222); *matched* 0,7442 vs ≈0,7111 (Δ=+0,0331).
...
**Dibandingkan dengan garis dasar pembanding test-locked yang dirujuk orkestrator** (F1 0,8069 / MAE 0,8909 / ±1 0,8091 / *matched* 0,8031 / makro-F1 0,6047): F1 0,8534 vs 0,8069 (Δ=+0,0465); MAE 0,7727 vs 0,8909 (Δ=−0,1182); ±1 0,8545 vs 0,8091 (Δ=+0,0454); *matched* 0,8162 vs 0,8031 (Δ=+0,0131); makro-F1 0,6519 vs 0,6047 (Δ=+0,0472).
