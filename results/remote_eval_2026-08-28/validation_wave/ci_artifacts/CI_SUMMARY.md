...
| Dataset | Metric | Point (new) | CI95 new | Point (garis dasar pembanding (*baseline*)) | CI95 garis dasar pembanding | Delta (new-baseline) | CI95 delta | P(delta>0) | Significant |
|---|---|---|---|---|---|---|---|---|---|
