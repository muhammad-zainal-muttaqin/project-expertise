...
| Pipeline V2 stage 1 + stage 2 | Depth | 172 | Beberapa kompromi performa (*trade-off*) membaik, belum all-round terhadap anchor |
| Cross-layer topology/count/class frontier | 953 | 815 detektor + 176 class = 991 | Mengulang kandidat robust; tidak menemukan all-rounder baru |
...
|---|---:|---:|---:|---:|---:|---|
| 953 anchor Hungarian | 0,823216 | 1,252747 | 0,670330 | 0,754204 | 0,601394 | Garis dasar pembanding (*baseline*) yang dipertahankan |
...
| Depth V2-only, best F1 | 0,845601 | 0,820513 | 0,837607 | 0,845011 | 0,686110 | Kompromi performa, bukan pengganti |
...
|---|---|---:|---:|---:|---:|---:|
| 953 | Garis dasar pembanding → mAP/GSP hasil terkunci | 0,804348 → **0,838710** | 1,392593 → **1,362963** | 0,614815 → **0,637037** | 0,7111 → **0,7442** | — |
| Depth | Garis dasar pembanding → GSP hasil terkunci | 0,806859 → **0,853408** | 0,890909 → **0,772727** | 0,809091 → **0,854545** | 0,8031 → **0,8162** | 0,6047 → **0,6519** |
