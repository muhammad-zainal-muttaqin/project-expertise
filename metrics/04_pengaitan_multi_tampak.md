...
|---|---|---|---:|---:|---:|---:|---:|---:|---:|---|---|
| `PT-E-001` | Model batas atas teoretis (*oracle*) Association Linker (tautan GT) | Kotak Acuan (*Ground Truth*) | 1,0000 | 1,0000 | 1,0000 | 1,0000 | 100,0% | N/A, model batas atas teoretis | N/A, model batas atas teoretis | `VALID` | `pipeline-pertandan/results/pt_e_001_oracle.json`, trivial benar secara definisi (tautan = GT); false-pool dan AUC tidak bermakna untuk model batas atas teoretis. |
