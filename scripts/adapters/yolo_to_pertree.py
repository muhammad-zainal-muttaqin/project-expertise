"""Adaptor: YOLO26l (ultralytics) -> JSON per-pohon (docs/SCHEMA-PERTREE.md).

Usage:
    .venv/bin/python yolo_to_pertree.py \
        --weights /path/to/yolo26l_e60_i1280_v2repro/best.pt \
        --image-dir /workspace/SawitMVC/images \
        --split-file /workspace/SawitMVC/test.txt --split-name test \
        --out-dir /workspace/project-expertise/runs/pertree/yolo26l_v2repro \
        --detector-name yolo26l_v2repro
"""
...
def main() -> None:
    ...
    ap.add_argument("--limit-trees", type=int, default=None)
    args = ap.parse_args()
