...
5. **Program evaluasi masih memiliki keterbatasan.** Skor F1 deteksi tandan belum memeriksa apakah seluruh kotak dalam satu kelompok benar-benar berasal dari tandan yang sama. Program evaluasi Pipeline Panen tidak menyertakan tiga pohon yang tercatat kosong. Program evaluasi juga mengalami galat ketika tidak ada prediksi.
